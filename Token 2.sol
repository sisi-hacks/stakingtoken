...
contract SeeseaToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    constructor(address initialOwner) ERC20("Seesea Token", "SSAI") Ownable(initialOwner) {
    ...
    // Helper function to determine the number of tokens per ETH
    function getTokenAmount(uint256 ethAmount) public pure returns (uint256) {
        uint256 rate = 40000; // 1 ETH = 40000 tokens @ price of 0.05 USDT
